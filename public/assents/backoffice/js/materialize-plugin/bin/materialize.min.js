                ...
                process: function (t) {
                    ...
                    if (n && a && i) {
                        ...
                        var r =
                            ...
                            s =
                                !this.pCenter ||
                                V(this.pCenter, t.center) < e.posThreshold;
                        if (
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    ...
                                    var i = {
                                        ...
                                        complete: function () {
                                            "function" ==
                                                typeof e.options.ready &&
                                                e.options.ready.call(
                                                    e,
                                                    e.$el,
                                                    e.openingTrigger
                                                );
                  ...
                  this.each(function () {
                      ...
                      (c = (function () {
                          ...
                          return (
                              ...
                              (u = t('<div class="backdrop"></div>')).appendTo(
                                  e
                              ),
                              e
                          );
                            ...
                            },
                            {
                                ...
                                value: function () {
                                    document.removeEventListener(
                                        ...
                                        i._container.parentNode.removeChild(
                                            i._container
                                        ),
                                        (i._container = null);
                                },
                            },
                            {
                                ...
                                value: function (e) {
                                    if (
                                        ...
                                        var n = t(e.target).closest(".toast")[0]
                                            .M_Toast;
                                        (n.panning = !0),
                                            (i._draggedToast = n),
                    ...
                    (this.setPlaceholder = function (t) {
                        ...
                        o.placeholder
                            ...
                            : (void 0 === t.data("chips") ||
                              ...
                              t
                                  .find("input")
                                  .prop("placeholder", o.secondaryPlaceholder);
                    }),
        ...
        function n(n, r) {
            ...
            (this.id = i("cp")),
                    ...
                    (r.ampmclickable
                        ? (this.spanAmPm.empty(),
                          ...
                          a('<div id="click-pm">PM</div>')
                              ...
                              .appendTo(this.spanAmPm))
                        : (this.spanAmPm.empty(),
                          a('<div id="click-am">AM</div>').appendTo(
                              this.spanAmPm
                          ),
                          a('<div id="click-pm">PM</div>').appendTo(
                              this.spanAmPm
                          ))),
                a(
                ...
                this.spanMinutes.click(
                    a.proxy(this.toggleView, this, "minutes")
                ),
                A.on(
            ...
            if (
                (d.on(p, function (t) {
                    0 === a(t.target).closest(".clockpicker-tick").length &&
                        l(t, !0);
                }),
                c)
            ) {
                    ...
                    (this.hours = +n[0] || 0),
                        ...
                        s.on(
                            ...
                            function (t) {
                                var e = a(t.target);
                                0 ===
                                    e.closest(i.popover.find(".picker__wrap"))
                                        .length &&
